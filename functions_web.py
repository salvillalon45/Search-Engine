...
def get_metadata(document_list):
...
def create_lemma_dictionary(document_list):
    """
    This function creates a dictionary. Each Doc ID will have its designated lemmatize tokens
    - Key: doc_id
    - Value: lemmatize tokens
...
def create_all_tokens_set(lemma_dictionary):
    """
    This function creates a set that contains all tokens from all documents
    """
    all_tokens_set = set()
...
def term_frequency(term, content_list):
    """
    Measures how frequently a term occurs in a document
    Parameters:
...
def inverse_document_frequency(term, amount_of_documents, postings_list_length):
    """
...
def term_frequency_idf(term, tokens, postings_list_length, amount_of_documents):
    """
    computes the TF-IDF score. It's the product of tf and idf.
    Parameters:
    - term: This is a word that we are looking for
...
def create_inverted_index(lemma_dictionary, all_tokens_set):
    """
    This function creates the inverted_index that has been discussed in class
    The inverted_index is a dictionary with:
    - Key: a token
...
def create_complete_inverted_index(lemma_dictionary, inverted_index, meta_data_dict):
    """
    This functions create inverted index from the project description
    - Key: token
    - Value: is a dictionary called dictionary_info_dict
...
def insert_complete_inverted_index_to_database(complete_inverted_index, lemma_dictionary):
    """
    This functions create the inserts the complete_inverted_index into the database
    """
...
def create_database_content(document_list, query):
    """
    This functions create the database content.
    """
...
def check_database_content(query):
    """
...
# ----------------------------------------------------
# def get_search_results_and_display(lemma_dictionary:dict, query:str) -> None:
def get_search_results_and_display(lemma_dictionary, query):
    is_database = True
...
def create_intersection_dict(search_results):
    doc_id_list = list()
...
def calculate_exact_match(lemma_dictionary, intersection_dict, query):
...
def display_result_query(result_dict):
    output = list()
    result_urls = list()
    ...
    output.append(desired_num_result)
...
def sort_dictionary(result_dictionary):
    """
    This function sorted the dictionary by value
    """
